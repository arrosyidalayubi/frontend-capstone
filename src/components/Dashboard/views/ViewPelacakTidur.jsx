...
export default function ViewPelacakTidur() {
  ...
  return (
    <div className="space-y-6 animate-fadeIn">
      <h2 className="text-2xl font-bold text-[var(--text-main)]">Analisis Tidur Terakhir</h2>
           ...
           {sleepChartData.map((height, i) => (
             <div 
              ...
              >
                ...
                <div className="opacity-0 group-hover:opacity-100 absolute -top-8 left-1/2 -translate-x-1/2 bg-[var(--bg-card)] text-indigo-900 text-xs font-bold px-2 py-1 rounded shadow-lg transition-opacity pointer-events-none">
                  {height}%
                </div>
             </div>
           ))}
