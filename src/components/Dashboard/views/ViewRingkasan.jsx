...
export default function ViewRingkasan() {
  return (
    <div className="space-y-6 animate-fadeIn">
      <div>
        <p className="text-sm text-[var(--text-muted)] font-medium mb-1">Minggu, 10 Mei • Minggu ke-14 perjalananmu</p>
        <h1 className="text-3xl font-extrabold text-[var(--text-main)] flex items-center gap-2">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        {/* Kalori */}
        <div className="bg-[var(--bg-card)] p-5 rounded-2xl border border-[var(--border-subtle)] shadow-sm flex flex-col justify-between h-36">
          ...
          <div>
            <h3 className="text-2xl font-bold text-[var(--text-main)]">1.125</h3>
            <p className="text-xs font-semibold text-[var(--text-muted)] uppercase tracking-wide mt-1">Kalori Hari Ini</p>
        ...
        <div className="bg-[var(--bg-card)] p-5 rounded-2xl border border-[var(--border-subtle)] shadow-sm flex flex-col justify-between h-36">
          ...
          <div>
            <h3 className="text-2xl font-bold text-[var(--text-main)]">8.500</h3>
            <p className="text-xs font-semibold text-[var(--text-muted)] uppercase tracking-wide mt-1">Langkah Hari Ini</p>
        ...
        <div className="bg-[var(--bg-card)] p-5 rounded-2xl border border-[var(--border-subtle)] shadow-sm flex flex-col justify-between h-36">
          ...
          <div>
            <h3 className="text-2xl font-bold text-[var(--text-main)]">72</h3>
            <p className="text-xs font-semibold text-[var(--text-muted)] uppercase tracking-wide mt-1">Detak Jantung</p>
        ...
        <div className="bg-[var(--bg-card)] p-5 rounded-2xl border border-[var(--border-subtle)] shadow-sm flex flex-col justify-between h-36">
          ...
          <div>
            <h3 className="text-2xl font-bold text-[var(--text-main)]">2.5</h3>
            <p className="text-xs font-semibold text-[var(--text-muted)] uppercase tracking-wide mt-1">Liter Air</p>
